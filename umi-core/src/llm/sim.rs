...
///
/// ```rust
/// use umi_core::llm::{SimLLMProvider, CompletionRequest, LLMProvider};
///
/// #[tokio::main]
/// async fn main() {
...
impl SimLLMProvider {
    ...
    ///
    /// ```rust
    /// use umi_core::dst::{Simulation, SimConfig};
    ...
    /// ```rust
    /// use umi_core::llm::SimLLMProvider;
    /// use umi_core::dst::{FaultConfig, FaultType, FaultInjector, DeterministicRng};
    /// use std::sync::Arc;
    ///
